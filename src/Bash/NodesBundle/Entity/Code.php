...
class Code implements ItemInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="CodeComment", mappedBy="id")
     */
    ...
    public function addComment(CodeComment $comment)
    {
...
//    }
     ...
     * Remove comments
     *
     * @param \Bash\NodesBundle\Entity\CodeComment $comments
     */
    public function removeComment(\Bash\NodesBundle\Entity\CodeComment $comments)
    {
