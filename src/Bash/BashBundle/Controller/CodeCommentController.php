...
use Bash\NodesBundle\Entity\CodeComment;
use Bash\NodesBundle\Form\CodeCommentType;
...
class CodeCommentController extends Controller
{
    public function newAction($id)
    {
        ...
        $form   = $this->createForm(new CodeCommentType(), $comment);
...
//          ->getForm();
        ...
        return $this->render('BashBashBundle:CodeComment:form.html.twig', array(
            'comment' => $comment,
...
//
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('BashBashBundle_codepost', array(
        ...
        return $this->render('BashBashBundle:Page:codepost.html.twig', array(
            'id' => $comment->getBlogId()->getId(),
    ...
    protected function getBlogId($id)
    {
        ...
        $quote = $em->getRepository('BashNodesBundle:Code')->find($id);
